...
exec sshpass -p "$PASSWORD" autossh -M 0  -o "StrictHostKeyChecking=$STRICT_HOST_KEY_CHECKING" -o "ServerAliveInterval $SERVER_ALIVE_INTERVAL" -o "ServerAliveCountMax $SERVER_ALIVE_COUNT_MAX" $@